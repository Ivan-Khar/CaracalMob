...
public class CaracalEntityModel extends EntityModel<CaracalEntity> {
	...
	public CaracalEntityModel() {
		...
		head.addChild(hats);
		hats.setTextureOffset(0, 8).addCuboid(-2.5F, -14.0F, -13.5F, 5.0F, 1.0F, 7.0F, 0.0F, false);
		hats.setTextureOffset(0, 16).addCuboid(-2.5F, -16.999F, -11.5F, 5.0F, 3.0F, 3.0F, 0.0F, false);

		hats_r1 = new ModelPart(this);
		hats_r1.setPivot(-1.1254F, -22.2308F, -10.0F);
		hats.addChild(hats_r1);
		hats_r1.setTextureOffset(0, 22).addCuboid(-1.9F, -1.9F, -1.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);

		hats_r2 = new ModelPart(this);
		hats_r2.setPivot(-0.4674F, -20.2865F, -10.0F);
		hats.addChild(hats_r2);
		hats_r2.setTextureOffset(0, 26).addCuboid(-0.9F, -2.0F, -0.4999F, 1.0F, 3.0F, 1.0F, 0.0F, false);

		hats_r3 = new ModelPart(this);
		hats_r3.setPivot(-0.1619F, -18.1779F, -10.0F);
		hats.addChild(hats_r3);
		hats_r3.setTextureOffset(8, 22).addCuboid(-1.5F, -1.4F, -1.5F, 3.0F, 3.0F, 3.0F, 0.0F, false);

		hats_r4 = new ModelPart(this);
		hats_r4.setPivot(0.0F, -15.499F, -10.0F);
		hats.addChild(hats_r4);
		hats_r4.setTextureOffset(0, 16).addCuboid(-2.5F, -1.501F, -1.5F, 5.0F, 3.0F, 3.0F, 0.0F, false);

		hats_r5 = new ModelPart(this);
		hats_r5.setPivot(0.0F, -13.5F, -10.0F);
		hats.addChild(hats_r5);
		hats_r5.setTextureOffset(0, 8).addCuboid(-2.5F, -0.499F, -3.5F, 5.0F, 1.0F, 7.0F, 0.0F, false);
		...
		anonymous_r1.setTextureOffset(46, 37).addCuboid(-3.1F, -3.4F, -4.9F, 0.0F, 1.0F, 5.0F, 0.0F, false);
		...
		head.addChild(beard);
		beard.setTextureOffset(17, 21).addCuboid(-2.0F, -0.2F, -1.3F, 4.0F, 2.0F, 2.0F, 0.0F, false);
		beard.setTextureOffset(17, 21).addCuboid(-1.3F, 1.8F, -1.1F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		beard.setTextureOffset(17, 21).addCuboid(-0.9F, 3.5F, -0.9F, 2.0F, 2.0F, 1.0F, 0.0F, false);
		beard.setTextureOffset(17, 21).addCuboid(-0.2F, 1.8F, -0.8F, 2.0F, 2.0F, 1.0F, 0.0F, false);

		beard_r1 = new ModelPart(this);
		beard_r1.setPivot(3.8023F, -0.8542F, -0.5F);
		beard.addChild(beard_r1);
		beard_r1.setTextureOffset(19, 24).addCuboid(-1.29F, -6.91F, -0.5F, 4.0F, 0.0F, 1.0F, 0.0F, false);
		beard_r1.setTextureOffset(19, 24).addCuboid(-1.29F, -0.61F, -0.5F, 4.0F, 0.0F, 1.0F, 0.0F, false);

		beard_r2 = new ModelPart(this);
		beard_r2.setPivot(2.5469F, 0.667F, -0.5F);
		beard.addChild(beard_r2);
		beard_r2.setTextureOffset(19, 22).addCuboid(-1.3F, 0.0F, -0.5F, 2.0F, 0.0F, 1.0F, 0.0F, false);

		beard_r3 = new ModelPart(this);
		beard_r3.setPivot(-2.4531F, 0.667F, -0.5F);
		beard.addChild(beard_r3);
		beard_r3.setTextureOffset(19, 22).addCuboid(-0.7F, 0.0F, -0.5F, 2.0F, 0.0F, 1.0F, 0.0F, false);
