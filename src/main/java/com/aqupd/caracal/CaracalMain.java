...
public class CaracalMain implements ModInitializer {
  ...
  public static final TagKey<Biome> CARACAL_SPAWN_BIOMES = TagKey.create(Registries.BIOME, new ResourceLocation("aqupd", "caracal_spawning_biomes"));
  ...
  public void onInitialize() {
    ...
    BiomeModifications.addSpawn(
      biomeSelectionContext -> biomeSelectionContext.hasTag(CARACAL_SPAWN_BIOMES),
      MobCategory.CREATURE, CaracalMain.CARACAL, weight, mingroup, maxgroup
    );
