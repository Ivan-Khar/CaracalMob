...
public class CaracalMain implements ModInitializer {
	...
	public void onInitialize() {
		...
		Registry.register(Registry.SOUND_EVENT, CaracalMain.CARACAL_SCREAM, CARACAL_AMBIENT);
		Registry.register(Registry.SOUND_EVENT, CaracalMain.CARACAL_HISSING, CARACAL_HISS);
